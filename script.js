...
tl.from('.text-4', 1.2, { ease: Circ.easeOut, right: 300 }, '-=1')

tl.from('.text-5', 0.8, { ease: Elastic.easeOut.config(1, 0.5), right: 300, delay: 1})

tl.from('.get-more', 0.5, { opacity: 0 }, '+=0.5');
